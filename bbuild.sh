...
BOEFFLA_VERSION="1.0-test-CM11-g900f"
EXTENDED_CMDLINE=""
...
MKBOOTIMG_CMDLINE="console=null androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 ehci-hcd.park=3"
...
step0_copy_code()
{
	...
	sed "s/\`echo \$LINUX_COMPILE_BY | \$UTS_TRUNCATE\`/Boeffla-Kernel-$BOEFFLA_VERSION-$BOEFFLA_DATE-[supported-by-www.hubo.in]/g" -i $BUILD_PATH/scripts/mkcompile_h
